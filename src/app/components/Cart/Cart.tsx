...
export default function Cart({ onClose, updateCartData }) {
  ...
  return (
    <div className="-ml-10 -mt-[4.8rem] w-screen h-screen bg-[#00000031] absolute">
      <div className="ml-auto w-[30rem] h-screen border-4 bg-white">
        <div className="mx-10 my-2" ref={ref}>
          <div className="border-b-2 border-[#7a666c] w-full p-4 pl-2 flex items-center justify-center gap-48">
            <h1 className="sniglet-extrabold text-2xl text-center">Your Cart</h1>
            <button className="sniglet-regular text-5xl" onClick={closeCart}>
              x
            </button>
          </div>
          <div className="overflow-y-auto h-[32rem] max-h-[32rem]">
          ...
          <div className="flex flex-col gap-4 sniglet-extrabold">
            <div className="border-t-2 py-2 border-[#7a666c] flex justify-between items-center text-neutral-700">
              ...
              <span className="ml-auto text-[1.3rem]">{totalAmount.toFixed(2)}$</span>
            </div>
            <Link href="/checkout">
              <button className="w-full p-3 bg-neutral-700 text-white">Checkout Page</button>
            </Link>
          </div>
        </div>
      </div>
